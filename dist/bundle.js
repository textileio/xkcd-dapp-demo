...
function getConstructor(n){return n?window.IpfsApi:window.Ipfs}function getCdnUrl(n){return n?"https://unpkg.com/ipfs-api/dist/index.min.js":"https://unpkg.com/ipfs/dist/index.min.js"}module.exports=function(n){return n=n||{},new Promise(function(r,e){if(window.ipfs)return r(window.ipfs);var t=function(){var t=new(getConstructor(n.api))(n.ipfs);if(n.api)return r(t);var i=function(){t.removeListener("error",o),r(t)},o=function(n){t.removeListener("ready",i),e(n)};t.once("ready",i).once("error",o)};if(getConstructor(n.api))return t();var i=document.createElement("script");i.src=n.cdn||getCdnUrl(n.api),i.onload=t,i.onerror=e,document.body.appendChild(i)})};

},{}],328:[function(require,module,exports){
"use strict";require("babel-polyfill");var ipfs,_window=require("window.ipfs-fallback"),_window2=_interopRequireDefault(_window);function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _asyncToGenerator(e){return function(){var t=e.apply(this,arguments);return new Promise(function(e,n){return function r(a,c){try{var i=t[a](c),o=i.value}catch(e){return void n(e)}if(!i.done)return Promise.resolve(o).then(function(e){r("next",e)},function(e){r("throw",e)});e(o)}("next")})}}var xkcdRoot="/ipfs/QmS74HhZt3ZekqUDqdttSgMsHwYQ6miDLwGUHy6pp4qLyD",fetchAndReplaceComic=function(){var e=_asyncToGenerator(regeneratorRuntime.mark(function e(t){var n,r,a,c,i,o,s,u,l,p,d;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.prev=0,e.next=3,ipfs.files.get(xkcdRoot+"/"+t);case 3:for(n=e.sent,r=!0,a=!1,c=void 0,e.prev=7,i=n[Symbol.iterator]();!(r=(o=i.next()).done);r=!0)s=o.value,u=String.fromCharCode.apply(null,s.content),l=document.getElementById("image"),s.name.endsWith(".png")?(p=btoa(u),l.setAttribute("src","data:image/png;base64,"+p),document.getElementById("permalink").textContent=t,document.getElementById("hotlink").textContent=xkcdRoot+"/"+s.path):s.name.endsWith("alt.txt")?(l.setAttribute("title",u),d=s.name.slice(s.name.indexOf("- ")+2,-10),document.getElementById("ctitle").textContent=d,l.setAttribute("alt",d)):s.name.endsWith("alt.txt")&&(document.getElementById("transcript").textContent=u);e.next=15;break;case 11:e.prev=11,e.t0=e.catch(7),a=!0,c=e.t0;case 15:e.prev=15,e.prev=16,!r&&i.return&&i.return();case 18:if(e.prev=18,!a){e.next=21;break}throw c;case 21:return e.finish(18);case 22:return e.finish(15);case 23:e.next=28;break;case 25:e.prev=25,e.t1=e.catch(0),console.log(e.t1);case 28:case"end":return e.stop()}},e,void 0,[[0,25],[7,11,15,23],[16,,18,22]])}));return function(t){return e.apply(this,arguments)}}(),setup=function(){var e=_asyncToGenerator(regeneratorRuntime.mark(function e(){var t,n,r,a,c,i,o,s,u,l,p,d,f,v,m,h,x,y,b,k,g,w,C,E,R,A;return regeneratorRuntime.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.prev=0,e.next=3,(0,_window2.default)();case 3:return ipfs=e.sent,t="/dns4/ipfs.carsonfarmer.com/tcp/4002/wss/ipfs/Qmf6Wp6McAKm5oRYUPndLaAs5tnADASyJJZ3HkhzPmJJvY",e.next=7,ipfs.swarm.connect(t);case 7:for(n=!0,r=!1,a=void 0,e.prev=10,c=document.getElementsByClassName("first")[Symbol.iterator]();!(n=(i=c.next()).done);n=!0)i.value.addEventListener("click",function(e){e.preventDefault(),fetchAndReplaceComic(1)},!0);e.next=18;break;case 14:e.prev=14,e.t0=e.catch(10),r=!0,a=e.t0;case 18:e.prev=18,e.prev=19,!n&&c.return&&c.return();case 21:if(e.prev=21,!r){e.next=24;break}throw a;case 24:return e.finish(21);case 25:return e.finish(18);case 26:for(o=!0,s=!1,u=void 0,e.prev=29,l=document.getElementsByClassName("last")[Symbol.iterator]();!(o=(p=l.next()).done);o=!0)p.value.addEventListener("click",function(e){e.preventDefault(),fetchAndReplaceComic(2003)},!0);e.next=37;break;case 33:e.prev=33,e.t1=e.catch(29),s=!0,u=e.t1;case 37:e.prev=37,e.prev=38,!o&&l.return&&l.return();case 40:if(e.prev=40,!s){e.next=43;break}throw u;case 43:return e.finish(40);case 44:return e.finish(37);case 45:for(d=!0,f=!1,v=void 0,e.prev=48,m=document.getElementsByClassName("random")[Symbol.iterator]();!(d=(h=m.next()).done);d=!0)h.value.addEventListener("click",function(e){e.preventDefault(),fetchAndReplaceComic(Math.floor(2003*Math.random())+1)},!0);e.next=56;break;case 52:e.prev=52,e.t2=e.catch(48),f=!0,v=e.t2;case 56:e.prev=56,e.prev=57,!d&&m.return&&m.return();case 59:if(e.prev=59,!f){e.next=62;break}throw v;case 62:return e.finish(59);case 63:return e.finish(56);case 64:for(x=!0,y=!1,b=void 0,e.prev=67,k=document.getElementsByClassName("prev")[Symbol.iterator]();!(x=(g=k.next()).done);x=!0)g.value.addEventListener("click",function(e){e.preventDefault();var t=parseInt(document.getElementById("permalink").textContent);t>1&&fetchAndReplaceComic(t-1)},!0);e.next=75;break;case 71:e.prev=71,e.t3=e.catch(67),y=!0,b=e.t3;case 75:e.prev=75,e.prev=76,!x&&k.return&&k.return();case 78:if(e.prev=78,!y){e.next=81;break}throw b;case 81:return e.finish(78);case 82:return e.finish(75);case 83:for(w=!0,C=!1,E=void 0,e.prev=86,R=document.getElementsByClassName("next")[Symbol.iterator]();!(w=(A=R.next()).done);w=!0)A.value.addEventListener("click",function(e){e.preventDefault();var t=parseInt(document.getElementById("permalink").textContent);t<2002&&fetchAndReplaceComic(t+1)},!0);e.next=94;break;case 90:e.prev=90,e.t4=e.catch(86),C=!0,E=e.t4;case 94:e.prev=94,e.prev=95,!w&&R.return&&R.return();case 97:if(e.prev=97,!C){e.next=100;break}throw E;case 100:return e.finish(97);case 101:return e.finish(94);case 102:e.next=107;break;case 104:e.prev=104,e.t5=e.catch(0),console.log(e.t5);case 107:return e.next=109,fetchAndReplaceComic(Math.floor(2003*Math.random())+1);case 109:document.getElementById("loading").style.visibility="hidden",document.getElementById("middleContainer").style.visibility="visible";case 111:case"end":return e.stop()}},e,void 0,[[0,104],[10,14,18,26],[19,,21,25],[29,33,37,45],[38,,40,44],[48,52,56,64],[57,,59,63],[67,71,75,83],[76,,78,82],[86,90,94,102],[95,,97,101]])}));return function(){return e.apply(this,arguments)}}();setup();

},{"babel-polyfill":1,"window.ipfs-fallback":327}]},{},[328]);
