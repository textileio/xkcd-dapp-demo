...
var ipfs;
var xkcdRoot = '/ipfs/QmWEAXcqwq5zY2u8Z1mii5m3MXricctd7efFep7sSEWZQz';

var fetchAndReplaceComic = function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(comicNumber) {
    var files, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, file, content, image, encoded, title;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return ipfs.files.get(xkcdRoot + '/' + comicNumber);
          ...
          case 3:
            ...
            for (_iterator = files[Symbol.iterator](); !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
              file = _step.value;
              content = String.fromCharCode.apply(null, file.content);
              ...
              if (file.name.endsWith('.png')) {
                ...
                document.getElementById('permalink').textContent = comicNumber;
                // Update IPFS hotlink
                document.getElementById('hotlink').textContent = xkcdRoot + '/' + file.path;
              } else if (file.name.endsWith('alt.txt')) {
                // Update comic title (hover)
                image.setAttribute('title', content);
                // Update comic title
                title = file.name.slice(file.name.indexOf('- ') + 2, -10);

                document.getElementById('ctitle').textContent = title;
                // Update comic image alt text
                image.setAttribute('alt', title);
              } else if (file.name.endsWith('alt.txt')) {
                document.getElementById('transcript').textContent = content;
              }
            }
            _context.next = 15;
            break;
    ...
    }, _callee, undefined, [[0, 25], [7, 11, 15, 23], [16,, 18, 22]]);
  }));

  return function fetchAndReplaceComic(_x) {
...
var setup = function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, element, _iteratorNormalCompletion3, _didIteratorError3, _iteratorError3, _iterator3, _step3, _element, _iteratorNormalCompletion4, _didIteratorError4, _iteratorError4, _iterator4, _step4, _element2, _iteratorNormalCompletion5, _didIteratorError5, _iteratorError5, _iterator5, _step5, _element3, _iteratorNormalCompletion6, _didIteratorError6, _iteratorError6, _iterator6, _step6, _element4;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ipfs = _context2.sent;
            _context2.next = 6;
            return ipfs.swarm.connect('/ip4/54.201.10.69/tcp/4002/ws/ipfs/QmQqBfDcAre7CaTMmMzHqnrHPxX3xVT5D5GaiHh4zppTL7');
          ...
          case 6:
            ...
            _context2.prev = 9;
            for (_iterator2 = document.getElementsByClassName('first')[Symbol.iterator](); !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          ...
          case 25:
            ...
            _context2.prev = 28;
            for (_iterator3 = document.getElementsByClassName('last')[Symbol.iterator](); !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
          ...
          case 44:
            ...
            _context2.prev = 47;
            for (_iterator4 = document.getElementsByClassName('random')[Symbol.iterator](); !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
              _element2 = _step4.value;
          ...
          case 63:
            ...
            _context2.prev = 66;
            for (_iterator5 = document.getElementsByClassName('prev')[Symbol.iterator](); !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
              _element3 = _step5.value;

              _element3.addEventListener('click', function (event) {
                event.preventDefault();
                var current = parseInt(document.getElementById('permalink').textContent);
                if (current > 1) {
          ...
          case 82:
            ...
            _context2.prev = 85;
            for (_iterator6 = document.getElementsByClassName('next')[Symbol.iterator](); !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
              _element4 = _step6.value;

              _element4.addEventListener('click', function (event) {
                event.preventDefault();
                var current = parseInt(document.getElementById('permalink').textContent);
                if (current < 2002) {
                  fetchAndReplaceComic(current + 1);
          ...
          case 106:
            _context2.next = 108;
            return fetchAndReplaceComic(Math.floor(Math.random() * 2003) + 1);
    ...
    }, _callee2, undefined, [[0, 103], [9, 13, 17, 25], [18,, 20, 24], [28, 32, 36, 44], [37,, 39, 43], [47, 51, 55, 63], [56,, 58, 62], [66, 70, 74, 82], [75,, 77, 81], [85, 89, 93, 101], [94,, 96, 100]]);
  }));
